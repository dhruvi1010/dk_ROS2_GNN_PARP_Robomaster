#include "rona_comm/cam_communication.hpp"
#include "rona_its_msgs/msg/cam.hpp"
...
CamCommunication::CamCommunication() : Node("cam_communication")
{
    ...
    cam_filtered_publisher_ = this->create_publisher<rona_its_msgs::msg::CAM>("cam_filtered", 2);
    cam_publisher_ = this->create_publisher<rona_its_msgs::msg::CAM>("/cam", 2);
    cam_subscriber_ = this->create_subscription<rona_its_msgs::msg::CAM>("/cam", 2, [this](rona_its_msgs::msg::CAM::SharedPtr msg) -> void { this->cam_callback(msg); });
...
void CamCommunication::cam_callback(const rona_its_msgs::msg::CAM::SharedPtr msg)
{   
...
{
    auto msg = rona_its_msgs::msg::CAM();
