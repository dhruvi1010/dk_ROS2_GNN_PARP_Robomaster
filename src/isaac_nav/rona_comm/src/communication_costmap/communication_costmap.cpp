#include "rona_comm/communication_costmap.hpp"
...
CommunicationCostmap::onInitialize()
{
  ...
  cam_sub_ = node->create_subscription<rona_its_msgs::msg::CAM>("/cam", rclcpp::QoS(1),[this](const rona_its_msgs::msg::CAM::SharedPtr msg) {cam_callback(msg);});
...
void CommunicationCostmap::cam_callback(const rona_its_msgs::msg::CAM::SharedPtr msg)
{
...
PLUGINLIB_EXPORT_CLASS(rona_comm::CommunicationCostmap, nav2_costmap_2d::Layer)
