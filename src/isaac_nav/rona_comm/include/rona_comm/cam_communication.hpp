...
class CamCommunication : public rclcpp::Node
{
    ...
    private:
        ...
        rclcpp::Subscription<rona_its_msgs::msg::CAM>::SharedPtr cam_subscriber_;
        rclcpp::Publisher<rona_its_msgs::msg::CAM>::SharedPtr cam_filtered_publisher_;
        rclcpp::Publisher<rona_its_msgs::msg::CAM>::SharedPtr cam_publisher_;
        ...
        //callback functions
        void cam_callback(const rona_its_msgs::msg::CAM::SharedPtr msg);
        void timer_callback();
