...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        #default_value=os.path.join(bringup_share, 'config', 'robomaster_nav2_radar.yaml'),# write down nav2_params for a slow velocity 
        default_value=os.path.join(bringup_share, 'config', 'gnn_robomaster_nav2_radar.yaml'),
    ...
    map_dir = LaunchConfiguration(
        'map',
        default=os.path.join(get_package_share_directory('rona_navigation'), 'maps', 'zft_hall_6_june.yaml'))
