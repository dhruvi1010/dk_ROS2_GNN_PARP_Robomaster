...
def generate_launch_description():
    ...
    # but does add a separate route_cost_puc_pynode with its own params YAML
    # for the GNN and PUC components = route_cost_puc node + CSV + rosbag.
    ...
    # =========================
    # Route Cost / PUC Node + CSV logger
    # =========================
