...
def generate_launch_description():
    ...
    declare_prefix_cmd = DeclareLaunchArgument(
        'prefix',
        default_value= os.environ.get("ROBOT", "robot0"),
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_share, 'config', 'robomaster_nav2_fast.yaml'),# write down nav2_params for a slow velocity 
    ...
    ld.add_action(bringup_cmd_group) # this is for navigation stack
    # ld.add_action(mqtt_cmd) # Uncomment this to enable mqtt
