...
#include "rona_mapping/toolbox_msgs.hpp"
...
protected:
  ...
  rclcpp::Client<rona_mapping::srv::Clear>::SharedPtr _clearChanges;
  rclcpp::Client<rona_mapping::srv::LoopClosure>::SharedPtr _saveChanges;
  rclcpp::Client<rona_mapping::srv::SaveMap>::SharedPtr _saveMap;
  rclcpp::Client<rona_mapping::srv::ClearQueue>::SharedPtr _clearQueue;
  rclcpp::Client<rona_mapping::srv::ToggleInteractive>::SharedPtr _interactive;
  rclcpp::Client<rona_mapping::srv::Pause>::SharedPtr _pause_measurements;
  rclcpp::Client<rona_mapping::srv::AddSubmap>::SharedPtr _load_submap_for_merging;
  rclcpp::Client<rona_mapping::srv::MergeMaps>::SharedPtr _merge;
  rclcpp::Client<rona_mapping::srv::SerializePoseGraph>::SharedPtr _serialize;
  rclcpp::Client<rona_mapping::srv::DeserializePoseGraph>::SharedPtr _load_map;
