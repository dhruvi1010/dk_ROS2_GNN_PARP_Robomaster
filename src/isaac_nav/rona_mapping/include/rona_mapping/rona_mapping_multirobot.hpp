...
protected:
  ...
  bool deserializePoseGraphCallback(
    ...
    std::shared_ptr<rona_mapping::srv::DeserializePoseGraph::Response> resp) override;
  void localizedScanCallback(
    rona_mapping::msg::LocalizedLaserScan::ConstSharedPtr localized_scan);
  LaserRangeFinder * getLaser(
    const rona_mapping::msg::LocalizedLaserScan::ConstSharedPtr localized_scan);
  using SlamToolbox::getLaser;

  std::shared_ptr<rclcpp::Publisher<rona_mapping::msg::LocalizedLaserScan>> localized_scan_pub_;
  rclcpp::Subscription<rona_mapping::msg::LocalizedLaserScan>::SharedPtr localized_scan_sub_;
