...
private:
  ...
  bool mergeMapCallback(
    ...
    const std::shared_ptr<rona_mapping::srv::MergeMaps::Request> req,
    std::shared_ptr<rona_mapping::srv::MergeMaps::Response> resp);
  bool addSubmapCallback(
    const std::shared_ptr<rmw_request_id_t> request_header,
    const std::shared_ptr<rona_mapping::srv::AddSubmap::Request> req,
    std::shared_ptr<rona_mapping::srv::AddSubmap::Response> resp);
  ...
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::MergeMaps>> ssMap_;
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::AddSubmap>> ssSubmap_;
