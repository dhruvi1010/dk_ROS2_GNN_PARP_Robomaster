...
#include "rona_mapping/visualization_utils.hpp"
...
private:
  ...
  rclcpp::Service<rona_mapping::srv::Clear>::SharedPtr ssClear_manual_;
  rclcpp::Service<rona_mapping::srv::LoopClosure>::SharedPtr ssLoopClosure_;
  rclcpp::Service<rona_mapping::srv::ToggleInteractive>::SharedPtr ssInteractive_;
