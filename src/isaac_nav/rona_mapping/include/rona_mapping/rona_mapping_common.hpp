...
#include "rona_mapping/toolbox_types.hpp"
#include "rona_mapping/slam_mapper.hpp"
#include "rona_mapping/snap_utils.hpp"
#include "rona_mapping/laser_utils.hpp"
#include "rona_mapping/get_pose_helper.hpp"
#include "rona_mapping/map_saver.hpp"
...
protected:
  ...
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::Pause>> ssPauseMeasurements_;
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::SerializePoseGraph>> ssSerialize_;
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::DeserializePoseGraph>> ssDesserialize_;
  std::shared_ptr<rclcpp::Service<rona_mapping::srv::Reset>> ssReset_;
