...
#include <memory>
#include <utility>
#include "rona_mapping/merge_maps_kinematic.hpp"
...
/*****************************************************************************/
{
  ...
  ssMap_ = this->create_service<rona_mapping::srv::MergeMaps>("rona_mapping/merge_submaps",
      std::bind(&MergeMapsKinematic::mergeMapCallback, this, std::placeholders::_1,
      std::placeholders::_2, std::placeholders::_3));
  ssSubmap_ = this->create_service<rona_mapping::srv::AddSubmap>("rona_mapping/add_submap",
