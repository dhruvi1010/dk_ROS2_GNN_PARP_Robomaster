...
/*****************************************************************************/
{
  server_ = node->template create_service<rona_mapping::srv::SaveMap>(
...
bool MapSaver::saveMapCallback(
  ...
  const std::shared_ptr<rona_mapping::srv::SaveMap::Request> req,
  std::shared_ptr<rona_mapping::srv::SaveMap::Response> response)
/*****************************************************************************/
{
  if (!received_map_) {
    RCLCPP_WARN(
