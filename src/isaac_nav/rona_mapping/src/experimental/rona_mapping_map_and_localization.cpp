...
#include <memory>
#include <string>
#include "rona_mapping/experimental/rona_mapping_map_and_localization.hpp"
...
/*****************************************************************************/
{
  ...
  ssSetLocalizationMode_ = create_service<std_srvs::srv::SetBool>(
    "rona_mapping/set_localization_mode",
...
RCLCPP_COMPONENTS_REGISTER_NODE(rona_mapping::MapAndLocalizationSlamToolbox)
