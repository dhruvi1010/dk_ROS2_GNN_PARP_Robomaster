...
#include "rona_mapping/rona_mapping_sync.hpp"
...
/*****************************************************************************/
{
  ...
  ssClear_ = this->create_service<rona_mapping::srv::ClearQueue>(
...
bool SynchronousSlamToolbox::clearQueueCallback(
  ...
  const std::shared_ptr<rona_mapping::srv::ClearQueue::Request> req,
  std::shared_ptr<rona_mapping::srv::ClearQueue::Response> resp)
/*****************************************************************************/
{
...
RCLCPP_COMPONENTS_REGISTER_NODE(rona_mapping::SynchronousSlamToolbox)
