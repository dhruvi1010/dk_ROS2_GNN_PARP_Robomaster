...
#include "rona_mapping/rona_mapping_multirobot.hpp"
...
/*****************************************************************************/
{
  ...
  localized_scan_pub_ = this->create_publisher<rona_mapping::msg::LocalizedLaserScan>(
    localized_scan_topic_, 10);
  localized_scan_sub_ = this->create_subscription<rona_mapping::msg::LocalizedLaserScan>(
...
/*****************************************************************************/
{
  rona_mapping::msg::LocalizedLaserScan scan_msg;
