...
#include "rona_mapping/loop_closure_assistant.hpp"
...
/*****************************************************************************/
{
  ...
  ssClear_manual_ = node->template create_service<rona_mapping::srv::Clear>(
    "rona_mapping/clear_changes", std::bind(&LoopClosureAssistant::clearChangesCallback,
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

  ssLoopClosure_ = node->template create_service<rona_mapping::srv::LoopClosure>(
    "rona_mapping/manual_loop_closure", std::bind(&LoopClosureAssistant::manualLoopClosureCallback,
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));

  scan_publisher_ = node->template create_publisher<sensor_msgs::msg::LaserScan>(
    "rona_mapping/scan_visualization", 10);
  ...
  ssInteractive_ = node->template create_service<rona_mapping::srv::ToggleInteractive>(
    "rona_mapping/toggle_interactive_mode", std::bind(&LoopClosureAssistant::interactiveModeCallback,
    this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));


  marker_publisher_ = node->template create_publisher<visualization_msgs::msg::MarkerArray>(
    "rona_mapping/graph_visualization", rclcpp::QoS(1));
...
/*****************************************************************************/
{
  ...
  visualization_msgs::msg::Marker m = vis_utils::toMarker(map_frame_, "rona_mapping", 0.1, clock_);
  ...
  edges_marker.id = 0;
  edges_marker.ns = "rona_mapping_edges";
  ...
  localization_edges_marker.ns = "rona_mapping_edges";
...
bool LoopClosureAssistant::manualLoopClosureCallback(
  ...
  const std::shared_ptr<rona_mapping::srv::LoopClosure::Request> req,
  std::shared_ptr<rona_mapping::srv::LoopClosure::Response> resp)
/*****************************************************************************/
{
...
bool LoopClosureAssistant::interactiveModeCallback(
  const std::shared_ptr<rmw_request_id_t> request_header,
  const std::shared_ptr<rona_mapping::srv::ToggleInteractive::Request>  req,
  std::shared_ptr<rona_mapping::srv::ToggleInteractive::Response> resp)
/*****************************************************************************/
{
  if(!enable_interactive_mode_)
  {
...
bool LoopClosureAssistant::clearChangesCallback(
  const std::shared_ptr<rmw_request_id_t> request_header,
  const std::shared_ptr<rona_mapping::srv::Clear::Request> req,
  std::shared_ptr<rona_mapping::srv::Clear::Response> resp)
/*****************************************************************************/
{
  if(!enable_interactive_mode_)
  {
