...
def generate_launch_description():
    ...
    nav2_bringup_launch = os.path.join(get_package_share_directory('nav2_bringup'), 'launch')
    ...
    # robots = []
    # for i in range(15):
    #     robot = {'name': 'robot' + str(i), 'x_pose': -0.5 * i, 'y_pose': 0.0, 'z_pose': 0.01}
    #     robots.append(robot)
    ...
    declare_urdf_file_cmd = DeclareLaunchArgument(
        ...
        description='Full path to the Nav2 parameters file to use for launched nodes')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(bringup_share, 'maps', 'pacelab_gazebo.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(bringup_share, 'config', 'rviz', 'nav2_namespaced_view.rviz'),
    ...
    for robot in robots:
        ...
        group = GroupAction([
            ...
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(bringup_share,
                                                           'launch',
                                                           'robomaster_simulation_launch.py')),
