...
def generate_launch_description() -> LaunchDescription:
    ...
    zed2_config_file = lu.get_path('rona_nvblox', 'config/sensors/zed2.yaml')
    zedx_config_file = lu.get_path('rona_nvblox', 'config/sensors/zedx.yaml')
    config_file_camera = lu.if_else_substitution(is_zedx, str(zedx_config_file),
                                                 str(zed2_config_file))
    config_file_common = lu.get_path('rona_nvblox', 'config/sensors/zed_common.yaml')
