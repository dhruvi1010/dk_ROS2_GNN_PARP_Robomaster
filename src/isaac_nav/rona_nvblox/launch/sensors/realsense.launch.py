...
EMITTER_FLASHING_CONFIG_FILE_PATH = lu.get_path('rona_nvblox', 'config/sensors/realsense_emitter_flashing.yaml')
EMITTER_ON_CONFIG_FILE_PATH = lu.get_path('rona_nvblox', 'config/sensors/realsense_emitter_on.yaml')
...
def add_cameras(args: lu.ArgumentContainer) -> List[Action]:
    ...
    for idx in range(num_cameras):
        ...
        nodes = []
        camera_name = f'{args.namespace}/camera{idx}'
        # Config file
        if run_splitter:
