...
def add_nvblox(args: lu.ArgumentContainer) -> List[Action]:
    ...
    base_config = lu.get_path('rona_nvblox', 'config/nvblox/nvblox_base.yaml')
    segmentation_config = lu.get_path('rona_nvblox',
                                      'config/nvblox/specializations/nvblox_segmentation.yaml')
    detection_config = lu.get_path('rona_nvblox',
                                   'config/nvblox/specializations/nvblox_detection.yaml')
    dynamics_config = lu.get_path('rona_nvblox',
                                  'config/nvblox/specializations/nvblox_dynamics.yaml')
    isaac_sim_config = lu.get_path('rona_nvblox',
                                   'config/nvblox/specializations/nvblox_sim.yaml')
    realsense_config = lu.get_path('rona_nvblox',
                                   'config/nvblox/specializations/nvblox_realsense.yaml')
    multi_realsense_config = lu.get_path(
        'rona_nvblox', 'config/nvblox/specializations/nvblox_multi_realsense.yaml')
    zed_config = lu.get_path('rona_nvblox',
    ...
    parameters.append({'global_frame': args.namespace + '/odom'})
    parameters.append({'map_clearing_frame_id': args.namespace + '/camera0_link'})
    parameters.append({'esdf_slice_bounds_visualization_attachment_frame_id': args.namespace + '/camera0_link'})
