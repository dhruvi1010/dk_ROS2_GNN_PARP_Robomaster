...
def add_vslam(args: lu.ArgumentContainer) -> List[Action]:
    ...
    if camera is NvbloxCamera.realsense:
        base_frame = args.namespace + '/base_footprint'
    else:
        base_frame = args.namespace + '/base_footprint'
    ...
    base_parameters = {
        'num_cameras': 2,
        'min_num_images': 2,
        'enable_localization_n_mapping': True, # it was False as default
        ...
        'map_frame': 'map',
        'odom_frame': args.namespace + '/odom',
    ...
    realsense_parameters = {
        ...
        'imu_frame': args.namespace + '/camera0_gyro_optical_frame',
        'camera_optical_frames': [
            args.namespace + '/camera0_infra1_optical_frame',
            args.namespace + '/camera0_infra2_optical_frame',
        ],
    }
...
def generate_launch_description() -> LaunchDescription:
    ...
    args.add_arg(
        ...
        cli=False) # it was True as default
