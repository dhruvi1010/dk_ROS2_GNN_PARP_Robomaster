...
def generate_launch_description():
    ...
    command_port_arg = DeclareLaunchArgument('command_port', default_value='/dev/ttyTI_cmd')
    baud_rate_arg = DeclareLaunchArgument('baud_rate', default_value='115200')

    data_port_arg = DeclareLaunchArgument('data_port', default_value='/dev/ttyTI_data')
    ...
    frame_id_arg = DeclareLaunchArgument('frame_id', default_value='/wave_sensor_link')
    ...
    #rosbag_base_dir = "/home/flw-6gem-dev/dev/6G_RoboFUSE_Dev/6g_demo_timmwave_radar_ros_pkg/rosbag_logs"
